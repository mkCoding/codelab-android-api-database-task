...
@Entity(tableName = "repos") //converting this class to a database table in Rooms
data class Repo(
    ...
    @field:SerializedName("query") val query: String //added query field here to keep track of each repo by query
)
