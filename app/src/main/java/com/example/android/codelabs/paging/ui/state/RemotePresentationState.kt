package com.example.android.codelabs.paging.ui.state
...
fun kotlinx.coroutines.flow.Flow<CombinedLoadStates>.asRemotePresentationState(): Flow<RemotePresentationState> =
